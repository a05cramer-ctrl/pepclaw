    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          height: '110px',
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(0,255,136,0.12) 0%, rgba(191,0,255,0.08) 100%)',
          border: '2px solid rgba(0,255,136,0.4)',
          boxShadow: '0 0 40px rgba(0,255,136,0.3), 0 0 80px rgba(191,0,255,0.15)',
        }}
      >
        <span
          className="font-orbitron neon-green"
          style={{ fontSize: '1.4rem', fontWeight: 900, letterSpacing: '2px' }}
        >
          PEP
        </span>
      </motion.div>
      ...
      {[0, 60, 120, 180, 240, 300].map((deg, i) => (
        <motion.div
          ...
          style={{
            ...
            width: '90px',
            height: '2px',
            background: `linear-gradient(90deg, transparent, ${i % 2 === 0 ? 'var(--neon-green)' : 'var(--electric-purple)'})`,
            transformOrigin: '0 0',
        ...
        >
          <div
            style={{
              ...
              height: '6px',
              borderRadius: '50%',
              background: i % 2 === 0 ? 'var(--neon-green)' : 'var(--electric-purple)',
              boxShadow: `0 0 8px ${i % 2 === 0 ? 'var(--neon-green)' : 'var(--electric-purple)'}`,
              transform: 'translate(-50%, -50%)',
            }}
          />
        </motion.div>
